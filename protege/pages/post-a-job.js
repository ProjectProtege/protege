...
const PostAJob = () => {
  return (
    <div className='container lg:w-4/5 xl:w-7/12 mb-12 flex flex-col items-center'>
      <h1 className='mb-3 text-2xl font-semibold text-blue-900'>Post a Job</h1>
      ...
      <p className='text-blue-700 text-sm lg:text-base lg:leading-relaxed mb-4 lg:text-center'>
        Our mission is to help those early in their tech career find their next
        opporunities to thrive. Below is a list we&apos;ve provided to help you
        determine if the role you&apos;re hiring for fits within our
      ...
      <p className='text-xs text-blue-900 lg:text-center lg:w-3/4 xl:w-full opacity-75'>
        Protegé.dev is a curated job board tailored towards junior developers.
        Each listing is reviewed, and approved or denied before going live. If
        your listing is denied, we&apos;ll contact you through email with
        suggested edits.
      </p>
    </div>
  )
