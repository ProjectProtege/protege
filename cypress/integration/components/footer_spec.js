describe('footer test', () => {
  ...
  it('tests the email input', () => {
    cy.get("[data-cy='mailing-list-signup']")
      .type('testemail@gmail.com')
      .should('have.value', 'testemail@gmail.com')
    cy.get("[data-cy='mailing-list-signup-button']").should(
      'have.text',
      'Sign Up'
    )
  ...
  it('checks the footer links', () => {
    cy.get("[data-cy='footer-links']>ul>li>a")
  ...
  it('checks that the twitter icon links correctly', () => {
    cy.get("[data-cy='footer-links']>a").should(
      'have.attr',
      'href',
      'https://twitter.com/devprotege'
    )
  })
})
